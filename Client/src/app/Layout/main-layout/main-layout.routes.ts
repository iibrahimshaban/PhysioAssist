...
export const MainLayoutRoutes: Routes = [
  ...
  },
  {
    path: 'schedule',
    loadComponent: () =>
      import('../../Features/Schedule/schedule-page.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../../Features/session-summary/session-summary.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../../Features/receptionist-scheduling/receptionist-scheduling.component').then(
        (c) => c.ReceptionistSchedulingComponent,
      ),
    canActivate: [permissionGuard],
  ...
  },
  {
    path: 'today-sessions',
    loadComponent: () =>
      import('../../Features/today-sessions-dashboard/today-sessions-dashboard.component').then(
        (c) => c.TodaySessionsDashboardComponent,
      ),
    canActivate: [permissionGuard],
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../../Features/scheduling-preferences/scheduling-preferences.component').then(
        (c) => c.SchedulingPreferencesComponent,
      ),
    canActivate: [permissionGuard],
    data: { permissions: ['WorkingSchedule:Read'] },
  },
  {
    ...
    loadComponent: () =>
      import('../../Features/documentation-settings/documentation-settings.component').then(
        (c) => c.DocumentationSettingsComponent,
      ),
  },
  {
    path: 'patients/:patientId/documentation',
    loadComponent: () =>
      import('../../Features/patient-documentation/patient-documentation.component').then(
        (m) => m.PatientDocumentationComponent,
      ),
  },
];
