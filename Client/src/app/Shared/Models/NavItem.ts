...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Reception', route: '/app/intake/reception', icon: 'pi pi-inbox', permissions: ['Intake:Review'], section: 'primary' },
  ...
  { label: 'Submissions', route: '/app/intake/submissions', icon: 'pi pi-inbox', permissions: ['Intake:Review'], section: 'settings' },
  { label: 'Staff', route: '/app/account/staff', icon: 'pi pi-id-card', permissions: ['receptionist:read'], section: 'settings' },
  { label: 'Intake Schemas', route: '/app/intake/schemas', icon: 'pi pi-file-edit', permissions: ['Intake:ManageForms'], section: 'settings' },
];