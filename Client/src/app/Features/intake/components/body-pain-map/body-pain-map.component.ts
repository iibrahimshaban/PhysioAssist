...
const BACK_REGIONS: BodyRegionDef[] = [
  ...
  {
    id: 'b-r-arm',
    labelEn: 'Right upper arm (back)',
    labelAr: 'ذراع أيمن خلفي',
    shape: 'rect',
    x: 22,
    y: 68,
    width: 14,
  ...
  {
    id: 'b-l-arm',
    labelEn: 'Left upper arm (back)',
    labelAr: 'ذراع أيسر خلفي',
    shape: 'rect',
    x: 94,
    y: 68,
    width: 14,
  ...
  {
    id: 'b-r-elbow',
    labelEn: 'Right elbow (back)',
    labelAr: 'كوع أيمن خلفي',
    shape: 'ellipse',
    cx: 29,
    cy: 110,
    rx: 9,
  ...
  {
    id: 'b-l-elbow',
    labelEn: 'Left elbow (back)',
    labelAr: 'كوع أيسر خلفي',
    shape: 'ellipse',
    cx: 101,
    cy: 110,
    rx: 9,
  ...
  {
    id: 'b-r-forearm',
    labelEn: 'Right forearm (back)',
    labelAr: 'ساعد أيمن خلفي',
    shape: 'rect',
    x: 23,
    y: 116,
    width: 12,
  ...
  {
    id: 'b-l-forearm',
    labelEn: 'Left forearm (back)',
    labelAr: 'ساعد أيسر خلفي',
    shape: 'rect',
    x: 95,
    y: 116,
    width: 12,
  ...
  {
    id: 'b-r-hand',
    labelEn: 'Right hand (back)',
    labelAr: 'يد يمنى خلفية',
    shape: 'ellipse',
    cx: 29,
    cy: 152,
    rx: 9,
  ...
  {
    id: 'b-l-hand',
    labelEn: 'Left hand (back)',
    labelAr: 'يد يسرى خلفية',
    shape: 'ellipse',
    cx: 101,
    cy: 152,
    rx: 9,
  ...
  {
    id: 'b-r-thigh',
    labelEn: 'Right thigh (back)',
    labelAr: 'فخذ أيمن خلفي',
    shape: 'rect',
    x: 44,
    y: 136,
    width: 20,
  ...
  {
    id: 'b-l-thigh',
    labelEn: 'Left thigh (back)',
    labelAr: 'فخذ أيسر خلفي',
    shape: 'rect',
    x: 66,
    y: 136,
    width: 20,
  ...
  {
    id: 'b-r-knee',
    labelEn: 'Right knee (back)',
    labelAr: 'ركبة يمنى خلفية',
    shape: 'ellipse',
    cx: 54,
    cy: 192,
    rx: 10,
  ...
  {
    id: 'b-l-knee',
    labelEn: 'Left knee (back)',
    labelAr: 'ركبة يسرى خلفية',
    shape: 'ellipse',
    cx: 76,
    cy: 192,
    rx: 10,
