...
public static class EmailBodyBuilder
{
    ...
    public static string EmailConfirmation(string userName, string otpCode) =>
        BaseTemplate(
            ...
            bodyMessage: "Thanks for signing up! Please use the code below to verify your " +
                         "email address and activate your PhysioAssist account.",
            otpCode: otpCode,
            codeLabel: "Verification code",
            accentColor: "#0F766E",
            accentBg: "#f0fdfa",
            footerNote: "If you didn't create a PhysioAssist account, you can safely ignore this email."
        );
    ...
    public static string PasswordReset(string userName, string otpCode) =>
        BaseTemplate(
            ...
            userName: userName,
            bodyMessage: "We received a request to reset the password for your PhysioAssist account. " +
    ...
    public static string ReportReady(string patientName, string pdfUrl, string qrImageUrl)
    {
        return $"""
        <!DOCTYPE html>
        <html lang="en">
                ...
                <tr>
                  <td style="padding:32px 36px 24px;text-align:center;">
                    ...
                    <p style="font-size:13px;color:#6b7280;line-height:1.7;margin:0 0 24px;text-align:left;">
                      Your treatment plan is ready. You can download the PDF below, or scan the QR code
                      to access it anytime from your phone.
                    </p>
                    ...
                    <div style="margin-top:20px;">
                      <img src="{qrImageUrl}" alt="QR Code" width="160" height="160"
